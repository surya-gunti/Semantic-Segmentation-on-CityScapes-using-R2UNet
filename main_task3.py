...
##Modified R2UNet Layers list
layers_list=[64, 128, 256, 512]
...
train_dataset = torchvision.datasets.Cityscapes('./cityscapes/', split='train', mode='fine', transform = transforms.Compose([transforms.ToTensor()]),
                     target_transform= transforms.Compose([transforms.ToTensor(), ]), target_type='semantic')

train_loader = DataLoader(train_dataset, batch_size=bs, shuffle=True )

val_dataset = torchvision.datasets.Cityscapes('./cityscapes/', split='val', mode='fine', transform = transforms.Compose([transforms.ToTensor()]),
                     target_transform= transforms.Compose([transforms.ToTensor(), ]), target_type='semantic')
